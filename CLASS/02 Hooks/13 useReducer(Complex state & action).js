/*This approach of having state object with different state variables is suitable for keep global state, when using local state, we can use multiple reducers instead*/
