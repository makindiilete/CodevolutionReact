/*
Key in react is an important factor when rendering list...
It helps react keeps track of which item in a list has been added, removed or updated in other to render the UI efficiently..

#   A key must be a unique property and you cannot define a prop using the 'key' value because it is a reserved keyword
*/
